...
import { useStory, useCanvas } from '@googleforcreators/story-editor';
/**
 * Internal dependencies
 */
import { elementWithFont, elementWithTextParagraphStyle } from '../shared';
import StoryPropTypes from '../types';
import { getCaretCharacterOffsetWithin } from './util';
...
function TextFrame({ element, element: { id, content, ...rest }, wrapperRef }) {
  ...
  // See https://github.com/google/googleforcreators/issues/7745.
  return (
    <Element
      ref={elementRef}
